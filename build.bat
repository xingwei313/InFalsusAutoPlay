...
set "PS=%PS% $bad=@('[AutoPlay]','not loaded','read threw','chart read found nothing','verdicts FINAL','NearEarly','FarEarly','unreadable','heading search','hover tooltip','planes: count=','has no FastText','will be kept saying','took over the assist row','handed back','hooked','unhooked','probe','dryrun','hidecursor','pernotelog','results skipped','could not be redirected','entering a chart');"
set "PS=%PS% $good=@('AUTO','AutoPlay','In Falsus Auto Play','autoplay','noscore','SongSelectScene','hooks installed','offsets agreed=','GameAssembly.dll');"
